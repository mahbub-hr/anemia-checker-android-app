...
public class RegisterActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        inputLastName = findViewById(R.id.lname);
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (!fname.isEmpty() && !lname.isEmpty() && !phone.isEmpty() && !age.isEmpty() && !email.isEmpty() && !password.isEmpty()) {
                    registerUser(fname,lname,phone, email,age, password);
                } else {
     ...
     * */
    private void registerUser(final String fname, final String lname, final String phone, final String email, final String age, final String password) {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        int login_id = user.getInt("login_id");
                       ...
                       db.addUser(Integer.toString(id), fname,lname,phone,email, uid,age, Integer.toString(login_id));
